                        ...
                        <div className="flex items-center space-x-4">
                            {user ? (
                                    ...
                                    {isProfileDropdownOpen && (
                                        <div className="absolute right-0 mt-3 w-64 bg-white rounded-2xl shadow-2xl border border-gray-100 py-2 z-50 animate-fade-in-up origin-top-right overflow-hidden">
                                            ...
                                            {user?.role === UserRole.BORROWER && (
                                                <a href="/dashboard?tab=profile" className="flex items-center space-x-3 px-4 py-3 text-sm text-gray-700 hover:bg-primary-light hover:text-primary transition-colors">
                                ...
                                <div className="relative" ref={headerDropdownRef}>
                                    ...
                                    <div className={`absolute right-0 top-full pt-2 transition-all duration-300 z-50 w-56 ${isHeaderDropdownOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}>
                                        <div className={`bg-white rounded-2xl shadow-2xl border border-gray-100 p-2 transform transition-all duration-300 ${isHeaderDropdownOpen ? 'translate-y-0' : 'translate-y-2'}`}>
                                            <button 
                                                onClick={() => {
