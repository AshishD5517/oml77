    ...
    <div className="bg-white p-6 rounded-lg border border-gray-200 hover:shadow-xl hover:border-primary transition-all duration-300 flex flex-col">
        <div className="flex justify-between items-start mb-4">
            <div>
             ...
             <div className="text-right flex items-center space-x-2 px-3 py-1 rounded-full bg-secondary text-white">
        ...
        <div className="grid grid-cols-2 gap-4 text-sm text-gray-600 mb-6">
            <div className="flex items-center space-x-2">
                ...
                <span>Term: <strong>{request.term} months</strong></span>
            </div>
            <div className="flex items-center space-x-2">
                ...
                <span>Requested: <strong>{request.dateRequested}</strong></span>
            </div>
        </div>
