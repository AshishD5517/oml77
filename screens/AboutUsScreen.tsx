            ...
            <div className="py-24 bg-white">
                <div className="container mx-auto px-6 max-w-5xl">
                    <div className="space-y-16">
                        ...
                        {/* Section 1 */}
                        <div className="bg-gray-50 p-10 rounded-3xl shadow-sm border border-gray-100 flex flex-col md:flex-row items-center gap-10">
                        ...
                        {/* Section 2 */}
                        <div className="bg-white p-10 rounded-3xl shadow-sm border border-gray-100 flex flex-col md:flex-row-reverse items-center gap-10">
                            <div className="flex-1">
