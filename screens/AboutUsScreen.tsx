            ...
            <div className="relative bg-secondary py-24 sm:py-32 isolate overflow-hidden">
                <img
                    ...
                    onError={(e) => {
                        ...
                        target.src = "https://picsum.photos/seed/office-hero/1200/800";
                    }}
                />
                    ...
                    <div className="grid md:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="relative">
                             ...
                             <img 
                                ...
                                onError={(e) => {
                                    const target = e.target as HTMLImageElement;
                                    target.src = "https://picsum.photos/seed/team-brainstorm/1200/800";
                                }}
                            />
                        </div>
                    </div>
                ...
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-3 gap-12 max-w-5xl mx-auto">
                        {[
                            ...
                            { name: 'Priya Singh', role: 'Head of Operations', img: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?q=80&w=800&auto=format&fit=crop' },
                            ...
                            <div key={idx} className="text-center group">
                                <div className="relative mb-6 inline-block rounded-full overflow-hidden w-48 h-48 border-4 border-primary shadow-lg group-hover:border-primary transition-all duration-300">
                                    <img 
                                        ...
                                        onError={(e) => {
                                            const target = e.target as HTMLImageElement;
                                            target.src = `https://i.pravatar.cc/300?u=${member.name}`;
                                        }}
                                    />
